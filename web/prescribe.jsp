                    ...
                    <div class="contents">
                        <div id="pdf-content">
                            <form method="post" action="GeneratePrescription"><br>
                                <div class="wrapper">
                                    <div class="prescription_form" style="width:900px">
                                        <div class="border box" style="height:130px; display:flex;">
                                    ...
                                    <div class="border box" style="height:220px; display:flex">
                                        <div class="border" style="width:50%; text-align: center;display: flex;justify-content: center;align-items: center">
                                    ...
                                    <div class="border box" style="height:auto; display:flex">
                                            ...
                                            <div class="Medicine">
                                                <div style="text-align:left">
                                                    <div style="display: flex">
                                                        ...
                                                        <select name="medicine" id="medicine" class="inner-item" style="width:190px; margin-left: 20px" required>
                                                    ...
                                                    <br>
                                                    <div style="display: flex">
                                                        <label for="timing" style="margin:10px">Timings:</label>
                                                        <!-- <input type="text" id="timing" min="1" required /> -->
                                                        <select name="dosage" type="text" id="timing" min="1" class="inner-item" style="margin-left: 36px;width:190px" required>
                                                    ...
                                                    <div style="display: flex">
                                                        ...
                                                        <label  for="timetotake" style="margin:10px">Time to Take:</label>
                                                        <!-- <input type="text" id="timing" min="1" required /> -->
                                                        <select name="time" type="text" id="timetotake" class="inner-item" style="width:190px" required>
    ...
    <script>
        ...
        function addbox() {
            ...
            textbox = '<div class="wd100" >' +
                    ...
                    '<select name="medicine" id="medicine" class="inner-item" style="margin-left:20px;width:190px" required>' +
                    ' <option value="" disabled selected>Select a medicine</option>' +
                    '<option value="Paracetamol">Paracetamol </option>' +
                    '<option value="Antacids ">Antacids</option>' +
                    '<option value="Ativan">Ativan</option>' +
                    ...
                    '  <select name="dosage" type="text" id="timing" class="inner-item" min="1" style="margin-left:36px;width:190px" required>' +
                    '     <option value="" disabled selected>Select timings</option>' +
                    '    <option value="1+1+1">1+1+1</option>' +
                    '   <option value="1+0+1">1+0+1</option>' +
                    '  <option value="0+1+1">1+1+1</option>' +
