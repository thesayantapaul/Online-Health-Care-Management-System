                                ...
                                <div class="form-block mx-auto">
                                    ...
                                    <form action="SignUp" method="POST">
                                        ...
                                        <div class="form-group first">
                                            ...
                                            <input name="firstName" type="text" class="form-control" placeholder="firstName" id="firstName">
                                        </div>


                                        <div class="form-group first">
                                            <label for="lastName">Last Name</label>
                                            <input name="lastName" type="text" class="form-control" placeholder="lastName" id="lastName">
                                        </div>                               
